...
enum class TokenType : u16 {
    // Keywords.
    KW_SELECT, KW_INSERT, KW_UPDATE, KW_DELETE, KW_EXPLAIN, KW_ANALYZE, KW_TRACE,
    ...
    KW_VARCHAR, KW_BOOL, KW_TEXT, KW_TIMESTAMP, KW_DATETIME,
    KW_TRUE, KW_FALSE,
    ...
    KW_CHECK,
    KW_NULLS, KW_FIRST, KW_LAST, KW_FORMAT, KW_JSON,
    KW_LEVEL, KW_CHANNELS, KW_EVENTS, KW_SUMMARY, KW_NORMAL, KW_VERBOSE, KW_DEBUG,
    KW_PIPELINE, KW_PLAN, KW_EXECUTOR, KW_STORAGE, KW_MVCC, KW_WAL, KW_LOCK,
    KW_MEMORY, KW_EVENT,
    KW_VACUUM,
